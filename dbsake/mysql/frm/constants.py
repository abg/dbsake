...
# Some notes here:
#  unireg_chekc = NONE may be set  to disable the typical DEFAULT CURRENT_TIMESTAMP behavior for datetimes
#  NEXT_NUMBER flags the column as AUTO_INCREMENT
#  TIMESTAMP_DN_FIELD means DEFAULT CURRENT_TIMESTAMP
#  TIMESTAMP_UN_FIELD means DEFAULT <default value> ON UPDATE CURRENT_TIMESTAMP
